...
procedure TROINDYTCPCHANNELINDYCLIENT_R(Self: TROINDYTCPCHANNEL; var T: TIDTCPCLIENT);
begin 
  T := Self.INDYCLIENT; 
end;
...
begin
  ...
  begin
    RegisterProperty('INDYCLIENT', 'TIDTCPCLIENT', iptr);
  end;
end;

procedure SIRegisterTIDTCPCLIENT(CL: TIFPSPascalCompiler);
begin
  with RegClassS(cl, 'TCOMPONENT', 'TIDTCPCLIENT') do
  begin
